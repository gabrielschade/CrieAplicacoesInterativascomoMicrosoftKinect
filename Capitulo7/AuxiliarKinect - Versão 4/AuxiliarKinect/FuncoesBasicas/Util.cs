...
namespace AuxiliarKinect.FuncoesBasicas
{
    public static class Util
    {
        ...
        public static double CalcularProdutoEscalar(Joint articulacao1, Joint articulacao2, Joint articulacao3)
        {
            ...
            double resultadoVW = vetorV.X * vetorW.X + 
                                 vetorV.Y * vetorW.Y + 
                                 vetorV.Z * vetorW.Z;

            double resultadoModuloVW = 
                Math.Sqrt( Math.Pow(vetorV.X, 2) + 
                           Math.Pow(vetorV.Y, 2) + 
                           Math.Pow(vetorV.Z, 2)) * 
            ...
            double resultadoRadianos = Math.Acos(resultadoVW / resultadoModuloVW);
